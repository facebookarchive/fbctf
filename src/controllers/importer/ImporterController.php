...
abstract class ImporterController {
  abstract public function importData(string $input_filename, string $type): ?array<string, mixed>;

  public async function processTeams(array<string, mixed> $teams): Awaitable<bool> {
  ...
  public async function processLevels(array<string, mixed> $levels): Awaitable<bool> {
  ...
  public async function processCategories(array<string, mixed> $categories): Awaitable<bool> {
  ...
  public async function processLogos(array<string, mixed> $logos): Awaitable<bool> {
